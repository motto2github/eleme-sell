<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect :select-type="selectType" :only-content="onlyContent" :ratings="ratings" @select-type-change="selectTypeChange" @only-content-toggle="onlyContentToggle"></ratingselect>
